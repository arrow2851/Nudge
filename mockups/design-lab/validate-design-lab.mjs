...
const INTERACTIVE_LOOKS = [3, 4, 5, 7];
...
function sharedInteractiveContract() {
  ...
  check(app.includes('new Set([3, 4, 5, 7])'), 'app.js does not register Looks #3, #4, #5, and #7 as interactive.');
...
function main() {
  ...
  else console.log('\nAll gallery and Looks #3/#4/#5/#7 interactive checks passed.');
}
