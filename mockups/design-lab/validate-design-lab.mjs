...
function requiredFiles() {
  const files = [
    ...
    'styles.css','foundation.css','look3.css','look4.css','look6.css','look6-quality.css','expanded-looks.css','review.css',
...
function versionsAndHtml(shared) {
  ...
  ['styles.css','foundation.css','look3.css','look4.css','look6.css','look6-quality.css','expanded-looks.css','review.css'].forEach(file => check(html.includes(`href="${file}"`), `index.html does not load ${file}.`));
...
function cssBalance() {
  const files = ['styles.css','foundation.css','look3.css','look4.css','look6.css','look6-quality.css','expanded-looks.css','review.css','look1-reference.css'];
  files.forEach(file => {
