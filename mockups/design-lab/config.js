...
export const LOOKS = Object.freeze([
  ...
  { id: 5, name: 'Playful Modular', status: 'Next Task hierarchy implementation', description: 'Colorful blocks and friendly controls that make upkeep feel approachable.' },
