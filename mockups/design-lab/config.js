...
export const LOOKS = Object.freeze([
  ...
  { id: 5, name: 'Playful Modular', status: 'New gallery direction', description: 'Colorful blocks and friendly controls that make upkeep feel approachable.' },
  ...
  { id: 7, name: 'Bold Utility', status: 'New gallery direction', description: 'High-contrast structure, thick rules, and unapologetically direct hierarchy.' },
  { id: 8, name: 'Ambient Glass', status: 'New gallery direction', description: 'Soft translucent layers, atmospheric depth, and calm modern polish.' },
